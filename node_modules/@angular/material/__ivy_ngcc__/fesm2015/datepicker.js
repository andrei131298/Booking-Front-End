...
function MatCalendarBody_tr_1_td_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatCalendarBody_tr_1_td_2_Template_td_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r26); const item_r23 = ctx.$implicit; const ctx_r25 = ɵngcc0.ɵɵnextContext(2); return ctx_r25._cellClicked(item_r23, $event); });
    ...
    ɵngcc0.ɵɵclassProp("mat-calendar-body-disabled", !item_r23.enabled)("mat-calendar-body-active", ctx_r22._isActiveCell(rowIndex_r20, colIndex_r24))("mat-calendar-body-range-start", ctx_r22._isRangeStart(item_r23.compareValue))("mat-calendar-body-range-end", ctx_r22._isRangeEnd(item_r23.compareValue))("mat-calendar-body-in-range", ctx_r22._isInRange(item_r23.compareValue))("mat-calendar-body-comparison-bridge-start", ctx_r22._isComparisonBridgeStart(item_r23.compareValue, rowIndex_r20, colIndex_r24))("mat-calendar-body-comparison-bridge-end", ctx_r22._isComparisonBridgeEnd(item_r23.compareValue, rowIndex_r20, colIndex_r24))("mat-calendar-body-comparison-start", ctx_r22._isComparisonStart(item_r23.compareValue))("mat-calendar-body-comparison-end", ctx_r22._isComparisonEnd(item_r23.compareValue))("mat-calendar-body-in-comparison-range", ctx_r22._isInComparisonRange(item_r23.compareValue))("mat-calendar-body-preview-start", ctx_r22._isPreviewStart(item_r23.compareValue))("mat-calendar-body-preview-end", ctx_r22._isPreviewEnd(item_r23.compareValue))("mat-calendar-body-in-preview", ctx_r22._isInPreview(item_r23.compareValue));
    ɵngcc0.ɵɵproperty("ngClass", item_r23.cssClasses)("tabindex", ctx_r22._isActiveCell(rowIndex_r20, colIndex_r24) ? 0 : 0 - 1);
    ɵngcc0.ɵɵattribute("data-mat-row", rowIndex_r20)("data-mat-col", colIndex_r24)("aria-label", item_r23.ariaLabel)("aria-disabled", !item_r23.enabled || null)("aria-selected", ctx_r22._isSelected(item_r23));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-calendar-body-selected", ctx_r22._isSelected(item_r23))("mat-calendar-body-today", ctx_r22.todayValue === item_r23.compareValue);
    ɵngcc0.ɵɵadvance(1);
...
function MatCalendar_mat_month_view_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("activeDate", ctx_r31.activeDate)("selected", ctx_r31.selected)("dateFilter", ctx_r31.dateFilter)("maxDate", ctx_r31.maxDate)("minDate", ctx_r31.minDate)("dateClass", ctx_r31.dateClass)("comparisonStart", ctx_r31.comparisonStart)("comparisonEnd", ctx_r31.comparisonEnd);
} }
