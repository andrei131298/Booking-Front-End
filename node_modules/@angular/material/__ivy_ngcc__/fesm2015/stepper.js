...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r61 = ctx.$implicit; return step_r61.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r67); const ctx_r66 = ɵngcc0.ɵɵnextContext(); return ctx_r66._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
...
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r71); const ctx_r70 = ɵngcc0.ɵɵnextContext(); return ctx_r70._animationDone.next($event); });
    ...
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r60._getStepLabelId(i_r69))("aria-expanded", ctx_r60.selectedIndex === i_r69);
    ɵngcc0.ɵɵadvance(1);
...
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("aria-labelledby", ctx_r72._getStepLabelId(i_r74))("aria-expanded", ctx_r72.selectedIndex === i_r74);
    ɵngcc0.ɵɵadvance(2);
